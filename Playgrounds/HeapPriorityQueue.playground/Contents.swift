...
var minHeap = PriorityQueue<Node> { (n1, n2) -> Bool in
    return n1.val < n2.val
}

minHeap.enqueue(Node(1, 2, 3))
minHeap.enqueue(Node(1, 2, 1))
minHeap.enqueue(Node(1, 2, 6))
minHeap.enqueue(Node(1, 2, 0))
minHeap.enqueue(Node(1, 2, 7))
minHeap.enqueue(Node(1, 2, -1))
minHeap.enqueue(Node(1, 2, 11))
print(minHeap.peek()?.val)
